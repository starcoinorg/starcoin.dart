...
abstract class Kind {
  ...
  static Kind deserialize(BinaryDeserializer deserializer) {
    ...
    switch (index) {
      case 0: return KindNewHeadsItem.load(deserializer);
      case 1: return KindEventsItem.load(deserializer);
      case 2: return KindNewPendingTransactionsItem.load(deserializer);
      case 3: return KindNewMintBlockItem.load(deserializer);
      default: throw new Exception("Unknown variant index for Kind: " + index.toString());
    }
  }
  ...
  static Kind fromJson(Map<String, dynamic> json){
    ...
    switch (type) {
      case 0: return KindNewHeadsItem.loadJson(json);
      case 1: return KindEventsItem.loadJson(json);
      case 2: return KindNewPendingTransactionsItem.loadJson(json);
      case 3: return KindNewMintBlockItem.loadJson(json);
      default: throw new Exception("Unknown type for Kind: " + type.toString());
    }
  }
