...
abstract class DataPath {
  ...
  static DataPath deserialize(BinaryDeserializer deserializer) {
    ...
    switch (index) {
      case 0:
        return DataPathCodeItem.load(deserializer);
      case 1:
        return DataPathResourceItem.load(deserializer);
      default:
        throw new Exception(
            "Unknown variant index for DataPath: " + index.toString());
    }
  }
  ...
  static DataPath fromJson(dynamic json) {
    ...
    switch (type) {
      case 0:
        return DataPathCodeItem.loadJson(json);
      case 1:
        return DataPathResourceItem.loadJson(json);
      default:
        throw new Exception("Unknown type for DataPath: " + type.toString());
    }
  }
...
class DataPathCodeItem extends DataPath {
  ...
  dynamic toJson() => {"value": value.toJson(), "type": 0, "type_name": "Code"};
...
class DataPathResourceItem extends DataPath {
  ...
  dynamic toJson() =>
      {"value": value.toJson(), "type": 1, "type_name": "Resource"};
